defmodule Playmark.TUI.Actions do
  ...
  alias Playmark.TUI.{Filter, HelpActions, Impl, Nav, PlaybackActions, QueueActions}
  ...
  # The history prompt is the core's last caller and its plural is irregular
  # ("history entries"), so this copy needs no default. It moves to
  # Playmark.TUI.HistoryActions with that caller.
